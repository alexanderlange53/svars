...
#'
#' Given an estimated VAR model, this function applies identification by means of a non-Gaussian likelihood for the instantaneous response matrix B of the corresponding SVAR model
...
#' A likelihood function of independent t-distributed structural shocks \eqn{\epsilon_t=B^{-1}u_t} is maximised with respect to B and the degrees of freedom of the t-ditribution (Lanne et al., 2017).
#'
