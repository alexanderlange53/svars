...
// nlm_rcpp
Rcpp::List nlm_rcpp(const arma::vec& S, double& Tob, double& TB, const arma::mat& Sigma_hat1, int& k, const arma::mat& Sigma_hat2, arma::mat& RestrictionMatrix, int& restrictions);
RcppExport SEXP _svars_nlm_rcpp(SEXP SSEXP, SEXP TobSEXP, SEXP TBSEXP, SEXP Sigma_hat1SEXP, SEXP kSEXP, SEXP Sigma_hat2SEXP, SEXP RestrictionMatrixSEXP, SEXP restrictionsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::vec& >::type S(SSEXP);
    Rcpp::traits::input_parameter< double& >::type Tob(TobSEXP);
    Rcpp::traits::input_parameter< double& >::type TB(TBSEXP);
    Rcpp::traits::input_parameter< const arma::mat& >::type Sigma_hat1(Sigma_hat1SEXP);
    Rcpp::traits::input_parameter< int& >::type k(kSEXP);
    Rcpp::traits::input_parameter< const arma::mat& >::type Sigma_hat2(Sigma_hat2SEXP);
    Rcpp::traits::input_parameter< arma::mat& >::type RestrictionMatrix(RestrictionMatrixSEXP);
    Rcpp::traits::input_parameter< int& >::type restrictions(restrictionsSEXP);
    rcpp_result_gen = Rcpp::wrap(nlm_rcpp(S, Tob, TB, Sigma_hat1, k, Sigma_hat2, RestrictionMatrix, restrictions));
    return rcpp_result_gen;
END_RCPP
}
