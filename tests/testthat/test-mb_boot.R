...
#
#   bbdc17 <- mb.boot(x1, b.length = 20, nboot = 10, n.ahead = 30, nc = 2, signrest = NULL)
...
#
#   bbcv17 <- mb.boot(x1, design ="fixed", b.length = 16, nboot = 10, n.ahead = 30, nc = 2, signrest = signrest)
