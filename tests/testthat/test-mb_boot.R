...
test_that("mb.boot returns valid object for id.dc", {
  ...
  bbdc6 <- mb.boot(x1, recursive = FALSE, b.length = 20, nboot = 50, n.ahead = 30, nc = 1, signrest = signrest)
...
test_that("mb.boot returns valid object for id.st", {
  ...
  bbst3 <- mb.boot(x1, recursive = FALSE, b.length = 10, nboot = 20, n.ahead = 30, nc = 2, signrest = NULL)
  ...
  bbst5 <- mb.boot(x1, recursive = FALSE, b.length = 15, nboot = 20, n.ahead = 30, nc = 2, signrest = signrest)
...
test_that("mb.boot returns valid object for id.ngml", {
  ...
  bbngml6 <- mb.boot(x1, recursive = FALSE, b.length = 15, nboot = 5, n.ahead = 30, nc = 2, signrest = signrest)
  expect_length(bbngml6, 12)
  expect_equal(bbngml6$nboot, 5)

  bbngml7 <- mb.boot(x1, recursive = FALSE, b.length = 15, nboot = 5, n.ahead = 30, nc = 2, signrest = NULL)
  ...
  bbngml9 <- mb.boot(x1, recursive = FALSE, b.length = 15, nboot = 5, n.ahead = 30, nc = 2, signrest = NULL)
  ...
  bbngml11 <- mb.boot(x1, recursive = FALSE, b.length = 15, nboot = 5, n.ahead = 30, nc = 2, signrest = NULL)
...
test_that("mb.boot returns valid object for id.st", {
  ...
  bbgarch5 <- mb.boot(x1, recursive = FALSE, b.length = 15, nboot = 10, n.ahead = 30, nc = 2, signrest = signrest)
  expect_length(bbgarch5, 12)
