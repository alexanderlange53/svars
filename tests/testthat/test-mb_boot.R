...
test_that("mb.boot returns valid object for id.dc", {
  ...
  bbdc2 <- mb.boot(x1, recursive = FALSE, b.length = 15, nboot = 50, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbdc2, 12)
  expect_equal(bbdc2$nboot, 50)

  bbdc3 <- mb.boot(x1, recursive = FALSE, b.length = 20, nboot = 50, n.ahead = 30, nc = 1, signrest = NULL)
  ...
  bbdc5 <- mb.boot(x1, b.length = 20, nboot = 50, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc5, 12)
  expect_equal(bbdc5$nboot, 50)

  bbdc6 <- mb.boot(x1, recursive = FALSE, b.length = 15, nboot = 50, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbdc6, 12)
  expect_equal(bbdc6$nboot, 50)

  bbdc7 <- mb.boot(x1, recursive = FALSE, b.length = 20, nboot = 50, n.ahead = 30, nc = 1, signrest = NULL)
...
test_that("mb.boot returns valid object for id.cv", {
  ...
  bbcv2 <- mb.boot(x1, recursive = FALSE, b.length = 20, nboot = 20, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbcv2, 12)
  expect_equal(bbcv2$nboot, 20)

  bbcv3 <- mb.boot(x1, recursive = FALSE, b.length = 10, nboot = 20, n.ahead = 30, nc = 1, signrest = NULL)
...
test_that("wild.boot returns valid object for id.ngml", {
  ...
  bbngml3 <- mb.boot(x1, recursive = FALSE, b.length = 15, nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbngml4 <- mb.boot(x1, b.length = 15, nboot = 5, n.ahead = 30, nc = 1, signrest = signrest)
  ...
  bbngml6 <- mb.boot(x1, recursive = FALSE, b.length = 15, nboot = 5, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbngml6, 12)
  expect_equal(bbngml6$nboot, 5)

  bbngml7 <- mb.boot(x1, recursive = FALSE, b.length = 15, nboot = 5, n.ahead = 30, nc = 1, signrest = NULL)
  ...
  bbngml8 <- mb.boot(x1, b.length = 15, nboot = 5, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbngml8, 12)
  expect_equal(bbngml8$nboot, 5)

  bbngml9 <- mb.boot(x1, recursive = FALSE, b.length = 15, nboot = 5, n.ahead = 30, nc = 1, signrest = NULL)
  ...
  bbngml10 <- mb.boot(x1, b.length = 15, nboot = 5, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbngml10, 12)
  expect_equal(bbngml10$nboot, 5)

  bbngml11 <- mb.boot(x1, recursive = FALSE, b.length = 15, nboot = 5, n.ahead = 30, nc = 1, signrest = NULL)
