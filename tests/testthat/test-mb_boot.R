...
test_that("mb.boot returns valid object for id.dc", {
  ...
  bbdc <- mb.boot(x1, b.length = 15, nboot = 50, horizon = 30, nc = 1, signrest = signrest)

  expect_length(bbdc, 12)
  expect_equal(bbdc$nboot, 50)

  bbdc1 <- mb.boot(x1, b.length = 20, nboot = 50, horizon = 30, nc = 1, signrest = NULL)
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbdc3 <- mb.boot(x1, b.length = 15, nboot = 50, horizon = 30, nc = 1, signrest = signrest)

  expect_length(bbdc3, 12)
  expect_equal(bbdc3$nboot, 50)

  bbdc4 <- mb.boot(x1, b.length = 20, nboot = 50, horizon = 30, nc = 1, signrest = NULL)
...
test_that("wild.boot works with parallelization", {
  ...
  bb <- mb.boot(x1, b.length = 20, nboot = 50, horizon = 30, nc = cores, signrest = NULL)
  expect_length(bb, 12)
...
test_that("wild.boot returns valid object for id.cv", {
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbcv <- mb.boot(x1, b.length = 20, nboot = 20, horizon = 30, nc = 1, signrest = signrest)

  expect_length(bbcv, 12)
  expect_equal(bbcv$nboot, 20)

  bbcv1 <- mb.boot(x1, b.length = 10, nboot = 20, horizon = 30, nc = 1, signrest = NULL)
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbcv2 <- mb.boot(x1, b.length = 15, nboot = 20, horizon = 30, nc = 1, signrest = signrest)
...
test_that("wild.boot returns valid object for id.ngml", {
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbngml <- mb.boot(x1, b.length = 15, nboot = 10, horizon = 30, nc = 1, signrest = signrest)

  expect_length(bbngml, 12)
  expect_equal(bbngml$nboot, 10)

  bbngml1 <- mb.boot(x1, b.length = 15, nboot = 10, horizon = 30, nc = 1, signrest = NULL)
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbngml3 <- mb.boot(x1, b.length = 15, nboot = 5, horizon = 30, nc = 1, signrest = signrest)

  expect_length(bbngml3, 12)
  expect_equal(bbngml3$nboot, 5)

  bbngml4 <- mb.boot(x1, b.length = 15, nboot = 5, horizon = 30, nc = 1, signrest = NULL)
  ...
  bbngml5 <- mb.boot(x1, b.length = 15, nboot = 5, horizon = 30, nc = 1, signrest = NULL)
  ...
  bbngml6 <- mb.boot(x1, b.length = 15, nboot = 5, horizon = 30, nc = 1, signrest = NULL)
