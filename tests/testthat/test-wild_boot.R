...
test_that("wild.boot returns valid object for id.dc", {
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbdc4 <- wild.boot(x2, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbdc4, 16)
  expect_equal(bbdc4$nboot, 10)

  bbdc5 <- wild.boot(x2, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc5, 16)
  expect_equal(bbdc5$nboot, 10)

  bbdc6 <- wild.boot(x2, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbdc6, 16)
  expect_equal(bbdc6$nboot, 10)

  bbdc7 <- wild.boot(x2, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbdc8 <- wild.boot(x3, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbdc8, 16)
  expect_equal(bbdc8$nboot, 10)

  bbdc9 <- wild.boot(x3, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc9, 16)
  expect_equal(bbdc9$nboot, 10)

  bbdc10 <- wild.boot(x3, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbdc10, 16)
  expect_equal(bbdc10$nboot, 10)

  bbdc11 <- wild.boot(x3, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc11, 16)
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbdc12 <- wild.boot(x4, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbdc12, 16)
  expect_equal(bbdc12$nboot, 10)

  bbdc13 <- wild.boot(x4, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc13, 16)
  expect_equal(bbdc13$nboot, 10)

  bbdc14 <- wild.boot(x4, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbdc14, 16)
  expect_equal(bbdc14$nboot, 10)

  bbdc15 <- wild.boot(x4, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc15, 16)
  expect_equal(bbdc15$nboot, 10)

  x1 <- id.dc(v1, PIT = FALSE)

  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbdc16 <- wild.boot(x1, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbdc16, 16)
  expect_equal(bbdc16$nboot, 10)

  bbdc17 <- wild.boot(x1, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc17, 16)
  expect_equal(bbdc17$nboot, 10)

  bbdc18 <- wild.boot(x1, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc18, 16)
  expect_equal(bbdc18$nboot, 10)

  bbdc19 <- wild.boot(x1, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbdc19, 16)
  expect_equal(bbdc19$nboot, 10)

  bbdc20 <- wild.boot(x1, design = "recursive", distr = "mammen", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc20, 16)
  expect_equal(bbdc20$nboot, 10)

  x2 <- id.dc(v2, PIT = FALSE)

  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbdc21 <- wild.boot(x2, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbdc21, 16)
  expect_equal(bbdc21$nboot, 10)

  bbdc22 <- wild.boot(x2, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc22, 16)
  expect_equal(bbdc22$nboot, 10)

  bbdc23 <- wild.boot(x2, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc23, 16)
  expect_equal(bbdc23$nboot, 10)

  bbdc24 <- wild.boot(x2, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbdc24, 16)
  expect_equal(bbdc24$nboot, 10)

  bbdc24 <- wild.boot(x2, design = "recursive", distr = "mammen", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc24, 16)
  expect_equal(bbdc24$nboot, 10)
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbdc25 <- wild.boot(x3, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbdc25, 16)
  expect_equal(bbdc25$nboot, 10)

  bbdc26 <- wild.boot(x3, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc126, 16)
  expect_equal(bbdc26$nboot, 10)

  bbdc27 <- wild.boot(x3, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc27, 16)
  expect_equal(bbdc27$nboot, 10)

  bbdc28 <- wild.boot(x3, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbdc28, 16)
  expect_equal(bbdc28$nboot, 10)

  bbdc29 <- wild.boot(x3, design = "recursive", distr = "mammen", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc29, 16)
  expect_equal(bbdc29$nboot, 10)

  x4 <- id.dc(v4, PIT = FALSE)

  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbdc30 <- wild.boot(x4, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbdc30, 16)
  expect_equal(bbdc30$nboot, 10)

  bbdc31 <- wild.boot(x4, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc31, 16)
  ...
  bbdc32 <- wild.boot(x4, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbdc32, 16)
  expect_equal(bbdc32$nboot, 10)

  bbdc33 <- wild.boot(x4, design = "recursive", distr = "mammen", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbdc33, 16)
...
test_that("wild.boot returns valid object for id.cv", {
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbcv4 <- wild.boot(x2, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbcv4, 16)
  expect_equal(bbcv4$nboot, 10)

  bbcv5 <- wild.boot(x2, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbcv5, 16)
  expect_equal(bbcv5$nboot, 10)

  bbcv6 <- wild.boot(x2, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbcv6, 16)
  expect_equal(bbcv6$nboot, 10)

  bbcv7 <- wild.boot(x2, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbcv8 <- wild.boot(x3, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbcv8, 16)
  expect_equal(bbcv8$nboot, 10)

  bbcv9 <- wild.boot(x3, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbcv9, 16)
  expect_equal(bbcv9$nboot, 10)

  bbcv10 <- wild.boot(x3, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbcv10, 16)
  expect_equal(bbcv10$nboot, 10)

  bbcv11 <- wild.boot(x3, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbcv11, 16)
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbcv12 <- wild.boot(x4, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbcv12, 16)
  expect_equal(bbcv12$nboot, 10)

  bbcv13 <- wild.boot(x4, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbcv13, 16)
  expect_equal(bbcv13$nboot, 10)

  bbcv14 <- wild.boot(x4, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbcv14, 16)
  expect_equal(bbcv14$nboot, 10)

  bbcv15 <- wild.boot(x4, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbcv15, 16)
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbcv16 <- wild.boot(x1, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbcv16, 16)
  expect_equal(bbcv16$nboot, 10)

  bbcv17 <- wild.boot(x1, design = "recursive", distr = "mammen", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbcv17, 16)
  expect_equal(bbcv17$nboot, 10)

  x2 <- id.cv(v2, SB = 59, restriction_matrix = restmat)

  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbcv18 <- wild.boot(x2, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbcv18, 16)
  expect_equal(bbcv18$nboot, 10)

  bbcv19 <- wild.boot(x2, design = "recursive", distr = "mammen", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbcv19, 16)
  expect_equal(bbcv19$nboot, 10)

  x3 <- id.cv(v3, SB = 59, restriction_matrix = restmat)

  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbcv20 <- wild.boot(x3, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbcv20, 16)
  expect_equal(bbcv20$nboot, 10)

  bbcv21 <- wild.boot(x3, design = "recursive", distr = "mammen", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbcv21, 16)
  expect_equal(bbcv21$nboot, 10)

  x4 <- id.cv(v4, SB = 59, restriction_matrix = restmat)

  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbcv22 <- wild.boot(x4, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbcv22, 16)
  expect_equal(bbcv22$nboot, 10)

  bbcv23 <- wild.boot(x4, design = "recursive", distr = "mammen", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbcv23, 16)
...
test_that("wild.boot returns valid object for id.st", {
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbst4 <- wild.boot(x2, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbst4, 16)
  expect_equal(bbst4$nboot, 10)

  bbst5 <- wild.boot(x2, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbst5, 16)
  expect_equal(bbst5$nboot, 10)

  bbst6 <- wild.boot(x2, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbst6, 16)
  expect_equal(bbst6$nboot, 10)

  bbst7 <- wild.boot(x2, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbst7, 16)
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbst8 <- wild.boot(x3, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbst8, 16)
  expect_equal(bbst8$nboot, 10)

  bbst9 <- wild.boot(x3, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbst9, 16)
  expect_equal(bbst9$nboot, 10)

  bbst10 <- wild.boot(x3, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbst10, 16)
  expect_equal(bbst10$nboot, 10)

  bbst11 <- wild.boot(x3, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbst11, 16)
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbst12 <- wild.boot(x4, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbst12, 16)
  expect_equal(bbst12$nboot, 10)

  bbst13 <- wild.boot(x4, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbst13, 16)
  expect_equal(bbst13$nboot, 10)

  bbst14 <- wild.boot(x4, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbst14, 16)
  expect_equal(bbst14$nboot, 10)

  bbst15 <- wild.boot(x4, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = NULL)
  expect_length(bbst15, 16)
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbst16 <- wild.boot(x1, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbst16, 16)
  expect_equal(bbst16$nboot, 10)

  bbst17 <- wild.boot(x1, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbst17, 16)
  expect_equal(bbst17$nboot, 10)

  x2 <- id.st(v2, c_fix = 80, gamma_fix = -1, restriction_matrix = restmat)

  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbst18 <- wild.boot(x2, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbst18, 16)
  expect_equal(bbst18$nboot, 10)

  bbst19 <- wild.boot(x2, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbst19, 16)
  expect_equal(bbst19$nboot, 10)

  x3 <- id.st(v3, c_fix = 80, gamma_fix = -1, restriction_matrix = restmat)

  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbst20 <- wild.boot(x3, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbst20, 16)
  expect_equal(bbst20$nboot, 10)

  bbst21 <- wild.boot(x3, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbst21, 16)
  expect_equal(bbst21$nboot, 10)

  x4 <- id.st(v4, c_fix = 80, gamma_fix = -1, restriction_matrix = restmat)

  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbst22 <- wild.boot(x4, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)

  expect_length(bbst22, 16)
  expect_equal(bbst22$nboot, 10)

  bbst23 <- wild.boot(x4, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 1, signrest = signrest)
  expect_length(bbst23, 16)
...
test_that("wild.boot returns valid object for id.ngml", {
  ...
  expect_length(bbngml15, 16)
  expect_equal(bbngml15$nboot, 10)

  x1 <- id.ngml(v1, stage3 = TRUE)

  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbngml16 <- wild.boot(x1, distr = "rademacher", nboot = 5, n.ahead = 30, nc = 2, signrest = signrest)

  expect_length(bbngml16, 16)
  expect_equal(bbngml16$nboot, 5)

  bbngml17 <- wild.boot(x1, distr = "rademacher", nboot = 5, n.ahead = 30, nc = 2, signrest = NULL)
  expect_length(bbngml17, 16)
  expect_equal(bbngml17$nboot, 5)

  bbngml18 <- wild.boot(x1, distr = "rademacher", nboot = 5, n.ahead = 30, nc = 2, signrest = NULL)
  expect_length(bbngml18, 16)
...
test_that("wild.boot returns valid object for id.garch", {
  ...
  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbgarch16 <- wild.boot(x1, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 2, signrest = signrest)

  expect_length(bbgarch16, 16)
  expect_equal(bbgarch16$nboot, 10)

  x2 <- id.garch(v2, restriction_matrix = restmat)

  signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
  bbgarch17 <- wild.boot(x2, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 2, signrest = signrest)

  expect_length(bbgarch17, 16)
