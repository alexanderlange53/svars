...
#
#   signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
#   bbdc17 <- wild.boot(x1, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 2, signrest = signrest)
#
#   expect_length(bbdc17, 17)
#   expect_equal(bbdc17$nboot, 10)
#
#   bbdc17 <- wild.boot(x1, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 2, signrest = NULL)
#   expect_length(bbdc17, 17)
#   expect_equal(bbdc17$nboot, 10)
#
...
#
#   signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
#   bbcv17 <- wild.boot(x1, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 2, signrest = signrest)
#
#   expect_length(bbcv17, 17)
#   expect_equal(bbcv17$nboot, 10)
#
#   bbcv17 <- wild.boot(x1, design = "recursive", distr = "mammen", nboot = 10, n.ahead = 30, nc = 2, signrest = signrest)
#   expect_length(bbcv17, 17)
#   expect_equal(bbcv17$nboot, 10)
#
...
#
#   signrest <- list(demand = c(1,1,1), supply = c(-1,1,1), money = c(-1,-1,1))
#   bbst17 <- wild.boot(x1, distr = "rademacher", nboot = 10, n.ahead = 30, nc = 2, signrest = signrest)
#
#   expect_length(bbst17, 17)
#   expect_equal(bbst17$nboot, 10)
#
#   bbst17 <- wild.boot(x1, design = "recursive", distr = "rademacher", nboot = 10, n.ahead = 30, nc = 2, signrest = signrest)
#   expect_length(bbst17, 17)
#   expect_equal(bbst17$nboot, 10)
#
